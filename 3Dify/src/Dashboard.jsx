...
const user = {
  ...
  imageUrl:
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWt5k6l3MRvnFJT4aCBBdEgDUxi54vGfINcg&s',
}
const navigation = [
    /* change the '#' later to a page we want to redirect to */
            ...
            <div className="flex h-16 items-center justify-between">
              <div className="flex items-center">
                <div className="shrink-0">
                  <img
                    alt="Your Company"
                    src="https://www.pngmart.com/files/22/Rubiks-Cube-PNG-Transparent-Picture.png"
                    className="size-8"
                  />
                </div>
